...
export default function FormattingControls({ editor }) {
  ...
  // List items and task items are different node types, so indent/outdent
  // must target whichever one the cursor is currently inside.
  ...
  return (
    <div className="flex flex-wrap items-center gap-1">
      ...
      <div className="flex items-center gap-1">
        ...
        <button onClick={indentListItem} className={btnBase} title="Indent" aria-label="Indent list item"><FaIndent /></button>
        <button onClick={outdentListItem} className={btnBase} title="Outdent" aria-label="Outdent list item"><FaOutdent /></button>
      </div>
