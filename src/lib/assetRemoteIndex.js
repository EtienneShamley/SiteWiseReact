...
// another's.
//
// DELIBERATELY NOT HERE (Phase 7.3 / 7.5): hydration from Firestore, any
// Firebase call, and any decision about WHEN an entry is stale. Nothing in
// the application writes to this store yet — it is populated by the phase
// that starts reading the cloud.
